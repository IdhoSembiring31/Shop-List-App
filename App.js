  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.mainWrapper}>
        ...
        {/* Sort Bar - Termurah, Tertinggi, Rating */}
        <View style={styles.sortBar}>
          <Text style={styles.productCount}>{filteredData.length} Produk</Text>
          <View style={styles.sortOptions}>
            <TouchableOpacity onPress={() => setSortType("Harga Terendah")}>
              <Text
                style={[
                  styles.sortLink,
                  sortType === "Harga Terendah" && styles.activeSort,
                ]}
              >
                Termurah
              </Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setSortType("Harga Tertinggi")}>
              <Text
                style={[
                  styles.sortLink,
                  sortType === "Harga Tertinggi" && styles.activeSort,
                ]}
              >
                Tertinggi
              </Text>
            ...
            <TouchableOpacity onPress={() => setSortType("Rating")}>
              <Text
                style={[
                  styles.sortLink,
                  sortType === "Rating" && styles.activeSort,
                ]}
              >
                Rating
              </Text>
...
const styles = StyleSheet.create({
  ...
  mainWrapper: { flex: 1, alignSelf: "center", width: "100%", maxWidth: 800 },
  ...
  detailImage: { width: "100%", height: 350, resizeMode: "contain" },
